...
class Stats extends ListPage{
	...
	function getPersonStats($id){
		...
		$this->ftfielding 	= $this->select($ftquery);
		...
		$this->fttotfielding 	= $this->select($ftquery);
		...
		$this->fthitting 	= $this->select($ftquery);
		...
		$this->fttothitting 	= $this->select($ftquery);
		/* add the total array to the beginning of the array */
		...
		$this->ftpitching 	= $this->select($ftquery);
		...
		$ftquery .= "FROM pitching s, teams t " . $ftwhere;
		$nrtotinnings = $this->select($ftquery);
		...
		$this->fttotpitching 	= $this->select($ftquery);
		/* add the total array to the beginning of the array */
